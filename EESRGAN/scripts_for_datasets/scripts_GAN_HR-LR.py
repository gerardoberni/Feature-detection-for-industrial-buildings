...
try:
    ...
    from utils import imresize_np #modificado, por el momento no hace falta calculate_ssim
    #from utils import imresize_np, calculate_psnr, calculate_ssim #original
except ImportError:
    pass
...
def generate_mod_LR_bic():
    ...
    for i in range(num_files):
        ...
        #image_LR = cv2.resize(image_HR, 1 / up_scale, True)
        # bic
        image_Bic = imresize_np(image_LR, up_scale, True)
        #image_Bic = cv2.resize(image_LR, up_scale, True)
...
refactor it later..
"/home/crowbar/Desktop/EESRGAN/Data/Processed/DetectionPatches_256x256/Potsdam_ISPRS/HR/x4/"
'''
def calculate_psnr_ssim():
    dir = "/home/crowbar/EESRGAN/Filter_Enhance_Detect/saved/"
    HR_DIR = "/home/crowbar/EESRGAN/Data/Processed/DetectionPatches_256x256/Potsdam_ISPRS/HR/x4/valid_img/*"
    bicubic_DIR = "/home/crownar/EESRGAN/Data/Processed/DetectionPatches_256x256/Potsdam_ISPRS/Bic/x4/valid_img/*"
    ...
    text_file = open("/home/crowbar/EESRGAN/Filter_Enhance_Detect/saved/Output_216000.txt", "a")
...
def calculate_psnr_ssim_ESRGAN():
    dir = "/home/crowbar/EESRGAN/Filter_Enhance_Detect/saved_ESRGAN/val_images/*/*"
    HR_DIR = "/home/crowbar/EESRGAN/Data/Processed/DetectionPatches_256x256/Potsdam_ISPRS/HR/x4/valid_img/"
    ...
    text_file = open("/home/crowbar/EESRGAN/Filter_Enhance_Detect/saved_ESRGAN/Output.txt", "a")
    print("SR PSNR: %4.2f"%avg_psnr_SR)
    text_file.write("SR PSNR: %4.2f \n"%avg_psnr_SR)
    print("SR SSIM: %5.4f"%avg_ssim_SR)
    text_file.write("SR SSIM: %5.4f \n"%avg_ssim_SR)
